    ...
    $output = '<header class="py-3 mb-4 border-bottom bg-white">
        <div class="d-flex flex-wrap justify-content-center container">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a href="add.php" class="nav-link text-dark">Add Todo</a></li>
...
function getTodo($todo)
{
    $output = '<div class="card shadow-sm">
        <div class="card-body">
            ...
            <br><br>
                <div class="btn-group">
                    <a href="view.php?id='. $todo['id'] .'" class="btn btn-sm btn-outline-secondary">View</a>
                    <a href="edit.php?id='. $todo['id'] .'" class="btn btn-sm btn-outline-secondary">Edit</a>
                </div>
