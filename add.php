...
if (isset($_POST["addTodo"])) {
    ...
    // Inserting todo
    $sql = "INSERT INTO todos (title, description, user_id, startdate, enddate) VALUES ('$title', '$desc', '$user_id', '$startDate','$endDate')";
    $res = mysqli_query($conn, $sql);
    if ($res) {
        $_POST["title"] = "";
        $_POST["desc"] = "";
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="startdate" value="<?php if (isset($_POST["addTodo"])) {
                                echo $_POST["startdate"];
                                } ?>" required><br>
                                <label for="enddate">End:</label>
                                <input type="date" name="enddate" value="<?php if (isset($_POST["addTodo"])) {
                                echo $_POST["enddate"];
                                } ?>" required>
                            </div>
                            <div>
